...
const { modalModulo, usuario, listSistemasModulos } =
...
const actualizarModal = (valor) => {
  ...
  sistema_Id.value = "";
  usuariosStore.actualizarModalModulos(valor);
};
...
const ModulosUsuarios = async (id) => {
  await sistemaModuloStore.loadModulosPerfiles(id, usuario.value.id);
};
